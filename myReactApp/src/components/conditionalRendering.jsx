...
// On Main page, when user clicks login button, change loggedIn = true and change Login button text to Logout, then Home component should be displayed,else Login Component